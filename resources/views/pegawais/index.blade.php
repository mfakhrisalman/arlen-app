                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-dark fw-bold" >Nama Pegawai</th>
                                <th class="min-w-125px text-dark fw-bold" >Nomor Telepon</th>
                                <th class="min-w-125px text-dark fw-bold" >Alamat</th>
                                <th class="min-w-125px text-dark fw-bold" >Jenis Kelamin</th>
                                <th class="min-w-125px text-dark fw-bold" >Posisi</th>
